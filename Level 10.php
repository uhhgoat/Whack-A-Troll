...
<html>
	...
	<body onload = "induction() ;">
		<audio preload = "auto" loop autoplay>
			<source src="Joker's Song - Full Music Video.m4a" type="audio/mpeg" autoplay = "true">
		</audio>
		<br />
	...
	<script>
		alert("If you see a Troll with Joker face paint, control-click it to remove him. If 9 Trolls appear on screen, you will lose! Good Luck!") ;
	</script>
</html>