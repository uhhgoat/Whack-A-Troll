...
<html>
	...
	<body onload = "induction() ;">
		<audio preload = "auto" loop autoplay>
			<source src="The devil went down to Georgia lyrics [original].m4a" type="audio/mpeg" autoplay = "true">
		</audio>
		<br />
	...
	<script>
		alert("If you see a Horned Troll, double click it to remove him. If 7 Trolls appear on screen, you will lose! Good Luck!") ;
	</script>
</html>