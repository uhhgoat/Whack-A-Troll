...
<html>
	...
	<body onload = "induction() ;">
		<audio preload = "auto" loop autoplay>
			<source src="Cuban Pete.m4a" type="audio/mpeg" autoplay = "true">
		</audio>
		<br />
	...
	<script>
		alert("If you see a Troll with a sombrero and mustache, right click it to remove him. If 9 Trolls appear on screen, you will lose! Good Luck!") ;
	</script>
</html>